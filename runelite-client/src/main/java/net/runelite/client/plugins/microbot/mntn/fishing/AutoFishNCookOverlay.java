...
public class AutoFishNCookOverlay extends OverlayPanel {


    @Inject
    AutoFishNCookOverlay(AutoFishNCookPlugin plugin)
    {
        super(plugin);
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(TitleComponent.builder()
                    .text("Zxch's Auto FishNCook " + AutoFishNCookScript.version)
                    .color(Color.ORANGE)
                    .build());
